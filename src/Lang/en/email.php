...
return [
    ...
    'view_discussion' => 'View the ' . mb_strtolower(trans('discussions::intro.titles.discussion')) . '.',
    ...
    'unsuscribe'      => [
        ...
        'link'    => 'Unsubscribe to this ' . mb_strtolower(trans('discussions::intro.titles.discussion')) . '.',
    ],
];
