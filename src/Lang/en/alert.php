...
return [
    'success' => [
        'title'  => 'Well done!',
        'reason' => [
            'submitted_to_post'       => 'Response successfully submitted to ' . mb_strtolower(trans('discussions::intro.titles.discussion')) . '.',
            'updated_post'            => 'Successfully updated the ' . mb_strtolower(trans('discussions::intro.titles.discussion')) . '.',
    ...
    'danger'  => [
        ...
        'reason' => [
            ...
            'create_discussion' => 'Whoops :( There seems to be a problem creating your ' . mb_strtolower(trans('discussions::intro.titles.discussion')) . '.',
